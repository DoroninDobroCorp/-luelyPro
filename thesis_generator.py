...
class GeminiThesisGenerator:
    ...
    def generate(self, question_text: str, n: int = 8, language: str = "ru", context: Optional[str] = None) -> List[str]:
        ...
        sys_instr = (
            ...
            "    • Вопросы (кто/что/где/когда/как/почему/сколько/зачем)"
            "    • Просьбы (расскажи/опиши/назови/покажи/объясни/дай/перечисли)"
            "    • Математику (посчитай, умножить, сколько будет)"
            "    • Любые сомнительные случаи → ПЫТАЙСЯ ОТВЕТИТЬ"
